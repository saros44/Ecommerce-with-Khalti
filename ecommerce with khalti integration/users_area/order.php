...
//getting quantity from cart_details table
...
//inserting data into user_orders table
...
$empt_cart = "DELETE FROM cart_details WHERE ip_address='$get_ip_address'";
$result_delete = mysqli_query($conn,$empt_cart);
